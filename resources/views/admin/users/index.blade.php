        ...
        <form method="GET" action="{{ route('admin.users.index') }}">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="email" name="email" class="form-control" placeholder="Buscar por correo"
                        value="{{ $filters['email'] ?? '' }}">
                </div>
            ...
            <div class="d-flex flex-column flex-md-row flex-wrap">
                ...
                <a href="{{ route('admin.users.index') }}" class="btn btn-light mr-md-2 mb-2 mb-md-0">
                    <i class="fas fa-eraser mr-1"></i>
                    Limpiar
                </a>

                <a href="{{ route('admin.exportaciones.users.excel', request()->query()) }}"
                    class="btn btn-success mr-md-2 mb-2 mb-md-0">
                    <i class="fas fa-file-excel mr-1"></i>
                    Exportar Excel
                </a>

                <a href="{{ route('admin.exportaciones.users.pdf', request()->query()) }}"
                    ...
                    <tbody>
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge badge-pill {{ !empty($user['provider']) ? 'badge-soft-success' : 'badge-soft-warning' }}">
