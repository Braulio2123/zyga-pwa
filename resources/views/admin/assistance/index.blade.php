...
@section('content_header')
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
        <div>
            ...
            <p class="zyga-muted mb-0">Vista operativa para priorizar solicitudes, validar estado y detectar intervención administrativa.</p>
        </div>
...
@section('content')
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 col-xl-2 mb-3"><div class="zyga-kpi"><div class="kpi-label">Completadas</div><div class="kpi-value">{{ $completedCount }}</div><div class="zyga-muted">Cerradas con éxito</div><div class="kpi-icon"><i class="fas fa-check-circle"></i></div></div></div>
        <div class="col-md-6 col-xl-2 mb-3"><div class="zyga-kpi"><div class="kpi-label">Canceladas</div><div class="kpi-value">{{ $cancelledCount }}</div><div class="zyga-muted">Casos cerrados por cancelación</div><div class="kpi-icon"><i class="fas fa-times-circle"></i></div></div></div>
    </div>
                        ...
                        <tbody>
                            @foreach($requests as $request)
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><a href="{{ route('admin.assistance.show', $request['id']) }}" class="btn btn-sm btn-outline-primary">Abrir caso</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
