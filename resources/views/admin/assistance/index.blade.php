...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
    <div>
        ...
        <p class="zyga-muted mb-0">Vista operativa para priorizar solicitudes, validar estado, detectar tracking y
            escalar intervención administrativa.</p>
    </div>
...
<div class="row mb-4">
    ...
    <div class="col-md-6 col-xl-2 mb-3">
        <div class="zyga-kpi">
            ...
            <div class="kpi-value">{{ $queueCount }}</div>
            <div class="zyga-muted">Esperando proveedor</div>
    ...
    <div class="col-md-6 col-xl-2 mb-3">
        <div class="zyga-kpi">
            ...
            <div class="zyga-muted">Con proveedor tomado</div>
    ...
    <div class="col-md-6 col-xl-2 mb-3">
        <div class="zyga-kpi">
            ...
            <div class="zyga-muted">Atención en proceso</div>
    ...
    <div class="col-md-6 col-xl-2 mb-3">
        <div class="zyga-kpi">
            ...
            <div class="kpi-value">{{ $trackingCount }}</div>
            <div class="zyga-muted">Con ubicación reciente</div>
            <div class="kpi-icon"><i class="fas fa-map-marker-alt"></i></div>
        </div>
    </div>
    <div class="col-md-6 col-xl-2 mb-3">
        <div class="zyga-kpi">
            <div class="kpi-label">Completadas/Canceladas</div>
            <div class="kpi-value">{{ $completedCount + $cancelledCount }}</div>
            <div class="zyga-muted">Casos cerrados</div>
...
<div class="card mb-4">
    <div class="card-header">
        <h3 class="zyga-section-title">Filtros operativos</h3>
    </div>
    <div class="card-body">
        <form method="GET" action="{{ route('admin.assistance.index') }}">
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" id="public_id" name="public_id" class="form-control"
                        placeholder="Ej. ZYG-2026-000001" value="{{ $filters['public_id'] ?? '' }}">
                </div>
                <div class="col-md-3 mb-3">
                    <label for="user_id">ID de cliente</label>
                    <input type="text" id="user_id" name="user_id" class="form-control" placeholder="Ej. 15"
                        value="{{ $filters['user_id'] ?? '' }}">
                </div>
                <div class="col-md-3 mb-3">
                    <label for="provider_id">ID de proveedor</label>
                    <input type="text" id="provider_id" name="provider_id" class="form-control" placeholder="Ej. 7"
            ...
            <div class="d-flex flex-column flex-md-row flex-wrap">
                ...
                <a href="{{ route('admin.assistance.index') }}" class="btn btn-light mr-md-2 mb-2 mb-md-0">
                    <i class="fas fa-eraser mr-1"></i>Limpiar
                </a>

                <a href="{{ route('admin.exportaciones.assistance.excel', request()->query()) }}"
                    class="btn btn-success mr-md-2 mb-2 mb-md-0">
                    <i class="fas fa-file-excel mr-1"></i>Exportar Excel
                </a>

                <a href="{{ route('admin.exportaciones.assistance.pdf', request()->query()) }}"
